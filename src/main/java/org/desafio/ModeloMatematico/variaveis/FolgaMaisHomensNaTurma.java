...
public class FolgaMaisHomensNaTurma extends Variavel {
    public Turma turma;

    public boolean dominio;
    public Double peso;

    public FolgaMaisHomensNaTurma(MPSolver solver, Turma turma) {
        this.turma = turma;
        this.dominio = true;
        this.peso = -1.0;
    ...
    public String toString() {
        return "v_FolgaMaisHomensNaTurma{" + turma.toString() + "}";
    }
}