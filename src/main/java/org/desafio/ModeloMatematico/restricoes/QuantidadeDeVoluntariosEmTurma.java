...
public class QuantidadeDeVoluntariosEmTurma {
    ...
    public QuantidadeDeVoluntariosEmTurma(MPSolver solver, Variaveis variaveis, Turma turma, ArrayList<AlocacaoDeVoluntarioNaTurma> alocacoesNaTurma) {
        ...
        MPVariable vFolgaMaxima = variaveis.makeNumVar(0, numeroMaximoDeVoluntarios, "v_FolgaDeNumeroMaximo{" + turma + "}", -1.0);
        MPVariable vFolgaMinima = variaveis.makeNumVar(0, numeroMinimoDeVoluntarios, "v_FolgaDeNumeroMinimo{" + turma + "}", -1.0);
